...
rizoel = "✯ 𝗡𝘂𝗰𝗹𝗲𝗮𝗿𝗫𝗦𝗽𝗮𝗺 𝗛𝗲𝗿𝗲 ✯\n\n"
rizoel += f"═══════════════════\n"
rizoel += f"• **ᴘʏᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `3.9.6`\n"
rizoel += f"• **ᴛᴇʟᴇᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `{version.__version__}`\n"
rizoel += f"• **ɴᴜᴄʟᴇᴀʀXsᴘᴀᴍ ᴠᴇʀsɪᴏɴ**  : `{rizoelversion}`\n"
rizoel += f"═══════════════════\n\n"   
...
async def alive(event):
  if event.sender_id in SUDO_USERS:
     await event.client.send_file(event.chat_id,
                                  ...
                                  buttons=[
        [
        Button.url("𝖈𝖍𝖆𝖓𝖓𝖊𝖑", "https://t.me/darkcircle"),
        Button.url("𝖌𝖗𝖔𝖚𝖕", "https://t.me/darkcircle")
        ],
        [
        Button.url("• 𝖗𝖊𝖕𝖔 •", "https://github.com/royal2011/SpamBot")
        ]
        ]
        )
...
async def restart(e):
    if e.sender_id in SUDO_USERS:
        text = "**Restarting Your Nuclear X Spam**.. Please Wait Until It Starts Again"
